                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index" class="d-inline-block auth-logo">
                                    <img src="{{ URL::asset('build/img/logo.png') }}" alt="" height="100">
                                </a>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}" autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="email" type="email"
                                                class="form-control @error('email') is-invalid @enderror" name="email"
                                                value="{{ old('email') }}" autofocus placeholder="Ingrese Email" required>
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                ...
                                                @endif
                                                {{-- <a href="auth-pass-reset-basic" class="text-muted">Olvido su Contraseña?</a> --}}
                                            </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">No posee Cuenta? <a href="register"
