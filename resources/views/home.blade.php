                    ...
                    <div class="flex-shrink-0">
                        <div class="dropdown card-header-dropdown">
                            <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <span class="fw-semibold text-uppercase fs-13">Sort by: </span><span class="text-muted">Nov
                        ...
                        <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Absternet LLC</td>
                                    <td>Sep 20, 2021</td>
                                    <td><img src="{{ URL::asset('build/img/users/avatar-1.jpg') }}" alt=""
                                ...
                                <tr>
                                    <td>Raitech Soft</td>
                                    <td>Sep 23, 2021</td>
                                    <td><img src="{{ URL::asset('build/img/users/avatar-2.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>William PVT</td>
                                    <td>Sep 27, 2021</td>
                                    <td><img src="{{ URL::asset('build/img/users/avatar-3.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>Loiusee LLP</td>
                                    <td>Sep 30, 2021</td>
                                    <td><img src="{{ URL::asset('build/img/users/avatar-4.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>Apple Inc.</td>
                                    <td>Sep 30, 2021</td>
                                    <td><img src="{{ URL::asset('build/img/users/avatar-6.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
                                        <a href="#javascript: void(0);" class="text-body fw-medium">Vitoria Rodrigues</a>
                                    </td>
                                    ...
                                    <div class="avatar-group">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img src="{{ URL::asset('build/img/users/avatar-1.jpg') }}" alt=""
                                        ...
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img src="{{ URL::asset('build/img/users/avatar-2.jpg') }}" alt=""
                                                    class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img src="{{ URL::asset('build/img/users/avatar-3.jpg') }}" alt=""
                                                    class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                    ...
                                    <div class="avatar-group">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img src="{{ URL::asset('build/img/users/avatar-4.jpg') }}" alt=""
                                                    class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img src="{{ URL::asset('build/img/users/avatar-5.jpg') }}" alt=""
                                                    class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                        ...
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                ...
                                                <img src="{{ URL::asset('build/img/users/avatar-7.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                    ...
                                    <div class="avatar-group">
                                        ...
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block"
                                                data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                data-bs-original-title="Stine Nielsen">
                                                <img src="{{ URL::asset('build/img/users/avatar-1.jpg') }}"
                                                    alt="" class="rounded-circle avatar-xxs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>William PVT</td>
                                    <td><img src="{{ URL::asset('build/img/users/avatar-7.jpg') }}" alt=""
                                            class="avatar-xs rounded-circle me-2">
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/dashboard.js') }}"></script>
